...
#import "TFHpple.h"
#import "BookObject.h"
#define DoubanLatestBookPath @"//div[@id='glide1']//li//a" //div[@id='glide1']//div[@class='detail-frame']//h2 | 
@implementation FictionExpressModel
    ...
    if ([keyPath isEqual:@"bookStatus"]) {
		...
		if ( bookStatus == Finish || bookStatus == Fail  ){
			...
			if (!numLatestBook) {
				...
				[ModelLocator sharedInstance].latestFictionBooks = self.books;
			}
		}
    }
}
