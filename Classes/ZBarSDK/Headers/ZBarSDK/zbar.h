...
/** set global library BCDebug level.
 * @param verbosity desired BCDebug level.  higher values create more spew
 */
extern void zbar_set_verbosity(int verbosity);

/** increase global library BCDebug level.
 * eg, for -vvvv
 */
...
/** dump raw image data to a file for BCDebug.
...
/** request a preferred video I/O mode for BCDebug/testing.  You will
...
/** force specific input and output formats for BCDebug/testing.
 * @note must be called before zbar_processor_init()
 */
...
/** request a preferred driver interface version for BCDebug/testing.
...
/** request a preferred I/O mode for BCDebug/testing.  You will get
...
/** initialize video using a specific format for BCDebug.
 ...
 * the overlay displays graphical data for informational or BCDebug
