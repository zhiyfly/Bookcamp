...
- (void) loadView {
	...
	_navBar.tintColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:1];
	...
	UINavigationItem				*navItem = [[[UINavigationItem alloc] initWithTitle: BCLocalizedString(@"Sina Weibo Info", nil)] autorelease];
